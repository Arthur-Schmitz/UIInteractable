...
namespace Com.ArthurSchmitz.UIInteractable {
    ...
    [Serializable] public class Scale         : Renderer      <Vector3               , RS_Scale     , Transform      > { protected override void Render(Vector3                parameter, Transform       target) => target.localScale = parameter ; }
